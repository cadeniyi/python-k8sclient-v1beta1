...
class V1Probe(object):
    ...
    def initial_delay_seconds(self):
        ...
        Number of seconds after the container has started before liveness probes are initiated. More info: http://releases.k8s.io/release-1.1/docs/user-guide/pod-states.md#container-probes
    ...
    def timeout_seconds(self):
        ...
        Number of seconds after which liveness probes timeout. Defaults to 1 second. More info: http://releases.k8s.io/release-1.1/docs/user-guide/pod-states.md#container-probes
