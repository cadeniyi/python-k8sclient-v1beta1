...
class V1SecurityContext(object):
    ...
    def capabilities(self):
        ...
        The linux kernel capabilites that should be added or removed. Default to Container.Capabilities if left unset. More info: http://releases.k8s.io/release-1.1/docs/design/security_context.md#security-context
    ...
    def privileged(self):
        ...
        Run the container in privileged mode. Default to Container.Privileged if left unset. More info: http://releases.k8s.io/release-1.1/docs/design/security_context.md#security-context
    ...
    def se_linux_options(self):
        ...
        SELinuxOptions are the labels to be applied to the container and volumes. Options that control the SELinux labels applied. More info: http://releases.k8s.io/release-1.1/docs/design/security_context.md#security-context
    ...
    def run_as_user(self):
        ...
        RunAsUser is the UID to run the entrypoint of the container process. The user id that runs the first process in the container. More info: http://releases.k8s.io/release-1.1/docs/design/security_context.md#security-context
