...
class V1PersistentVolumeClaimVolumeSource(object):
    ...
    def claim_name(self):
        ...
        ClaimName is the name of a PersistentVolumeClaim in the same namespace as the pod using this volume. More info: http://releases.k8s.io/release-1.1/docs/user-guide/persistent-volumes.md#persistentvolumeclaims
