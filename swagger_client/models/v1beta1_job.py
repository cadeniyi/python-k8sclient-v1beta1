...
class V1beta1Job(object):
    ...
    def spec(self):
        ...
        Spec is a structure defining the expected behavior of a job. More info: http://releases.k8s.io/release-1.1/docs/devel/api-conventions.md#spec-and-status
    ...
    def status(self):
        ...
        Status is a structure describing current status of a job. More info: http://releases.k8s.io/release-1.1/docs/devel/api-conventions.md#spec-and-status
