...
class V1CinderVolumeSource(object):
    ...
    def volume_id(self):
        ...
        volume id used to identify the volume in cinder More info: http://releases.k8s.io/release-1.1/examples/mysql-cinder-pd/README.md
    ...
    def fs_type(self):
        ...
        Required: Filesystem type to mount. Must be a filesystem type supported by the host operating system. Only ext3 and ext4 are allowed More info: http://releases.k8s.io/release-1.1/examples/mysql-cinder-pd/README.md
    ...
    def read_only(self):
        ...
        Optional: Defaults to false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts. More info: http://releases.k8s.io/release-1.1/examples/mysql-cinder-pd/README.md
