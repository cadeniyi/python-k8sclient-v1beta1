...
class V1PodSpec(object):
    ...
    def volumes(self):
        ...
        List of volumes that can be mounted by containers belonging to the pod. More info: http://releases.k8s.io/release-1.1/docs/user-guide/volumes.md
    ...
    def containers(self):
        ...
        List of containers belonging to the pod. Containers cannot currently be added or removed. There must be at least one container in a Pod. Cannot be updated. More info: http://releases.k8s.io/release-1.1/docs/user-guide/containers.md
    ...
    def restart_policy(self):
        ...
        Restart policy for all containers within the pod. One of Always, OnFailure, Never. Default to Always. More info: http://releases.k8s.io/release-1.1/docs/user-guide/pod-states.md#restartpolicy
    ...
    def node_selector(self):
        ...
        NodeSelector is a selector which must be true for the pod to fit on a node. Selector which must match a node's labels for the pod to be scheduled on that node. More info: http://releases.k8s.io/release-1.1/docs/user-guide/node-selection/README.md
    ...
    def service_account_name(self):
        ...
        ServiceAccountName is the name of the ServiceAccount to use to run this pod. More info: http://releases.k8s.io/release-1.1/docs/design/service_accounts.md
