...
class V1RBDVolumeSource(object):
    ...
    def monitors(self):
        ...
        A collection of Ceph monitors. More info: http://releases.k8s.io/release-1.1/examples/rbd/README.md#how-to-use-it
    ...
    def image(self):
        ...
        The rados image name. More info: http://releases.k8s.io/release-1.1/examples/rbd/README.md#how-to-use-it
    ...
    def fs_type(self):
        ...
        Filesystem type of the volume that you want to mount. Tip: Ensure that the filesystem type is supported by the host operating system. Examples: \"ext4\", \"xfs\", \"ntfs\". More info: http://releases.k8s.io/release-1.1/docs/user-guide/volumes.md#rbd
    ...
    def pool(self):
        ...
        The rados pool name. Default is rbd. More info: http://releases.k8s.io/release-1.1/examples/rbd/README.md#how-to-use-it.
    ...
    def user(self):
        ...
        The rados user name. Default is admin. More info: http://releases.k8s.io/release-1.1/examples/rbd/README.md#how-to-use-it
    ...
    def keyring(self):
        ...
        Keyring is the path to key ring for RBDUser. Default is /etc/ceph/keyring. More info: http://releases.k8s.io/release-1.1/examples/rbd/README.md#how-to-use-it
    ...
    def secret_ref(self):
        ...
        SecretRef is name of the authentication secret for RBDUser. If provided overrides keyring. Default is empty. More info: http://releases.k8s.io/release-1.1/examples/rbd/README.md#how-to-use-it
    ...
    def read_only(self):
        ...
        ReadOnly here will force the ReadOnly setting in VolumeMounts. Defaults to false. More info: http://releases.k8s.io/release-1.1/examples/rbd/README.md#how-to-use-it
