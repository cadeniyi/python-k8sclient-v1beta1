...
class V1GCEPersistentDiskVolumeSource(object):
    ...
    def pd_name(self):
        ...
        Unique name of the PD resource in GCE. Used to identify the disk in GCE. More info: http://releases.k8s.io/release-1.1/docs/user-guide/volumes.md#gcepersistentdisk
    ...
    def fs_type(self):
        ...
        Filesystem type of the volume that you want to mount. Tip: Ensure that the filesystem type is supported by the host operating system. Examples: \"ext4\", \"xfs\", \"ntfs\". More info: http://releases.k8s.io/release-1.1/docs/user-guide/volumes.md#gcepersistentdisk
    ...
    def read_only(self):
        ...
        ReadOnly here will force the ReadOnly setting in VolumeMounts. Defaults to false. More info: http://releases.k8s.io/release-1.1/docs/user-guide/volumes.md#gcepersistentdisk
