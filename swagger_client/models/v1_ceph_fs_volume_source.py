...
class V1CephFSVolumeSource(object):
    ...
    def monitors(self):
        ...
        Required: Monitors is a collection of Ceph monitors More info: http://releases.k8s.io/release-1.1/examples/cephfs/README.md#how-to-use-it
    ...
    def user(self):
        ...
        Optional: User is the rados user name, default is admin More info: http://releases.k8s.io/release-1.1/examples/cephfs/README.md#how-to-use-it
    ...
    def secret_file(self):
        ...
        Optional: SecretFile is the path to key ring for User, default is /etc/ceph/user.secret More info: http://releases.k8s.io/release-1.1/examples/cephfs/README.md#how-to-use-it
    ...
    def secret_ref(self):
        ...
        Optional: SecretRef is reference to the authentication secret for User, default is empty. More info: http://releases.k8s.io/release-1.1/examples/cephfs/README.md#how-to-use-it
    ...
    def read_only(self):
        ...
        Optional: Defaults to false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts. More info: http://releases.k8s.io/release-1.1/examples/cephfs/README.md#how-to-use-it
