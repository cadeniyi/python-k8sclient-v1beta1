...
class V1beta1Ingress(object):
    ...
    def spec(self):
        ...
        Spec is the desired state of the Ingress. More info: http://releases.k8s.io/release-1.1/docs/devel/api-conventions.md#spec-and-status
    ...
    def status(self):
        ...
        Status is the current state of the Ingress. More info: http://releases.k8s.io/release-1.1/docs/devel/api-conventions.md#spec-and-status
