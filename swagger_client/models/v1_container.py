...
class V1Container(object):
    ...
    def image(self):
        ...
        Docker image name. More info: http://releases.k8s.io/release-1.1/docs/user-guide/images.md
    ...
    def resources(self):
        ...
        Compute Resources required by this container. Cannot be updated. More info: http://releases.k8s.io/release-1.1/docs/user-guide/persistent-volumes.md#resources
    ...
    def liveness_probe(self):
        ...
        Periodic probe of container liveness. Container will be restarted if the probe fails. Cannot be updated. More info: http://releases.k8s.io/release-1.1/docs/user-guide/pod-states.md#container-probes
    ...
    def readiness_probe(self):
        ...
        Periodic probe of container service readiness. Container will be removed from service endpoints if the probe fails. Cannot be updated. More info: http://releases.k8s.io/release-1.1/docs/user-guide/pod-states.md#container-probes
    ...
    def image_pull_policy(self):
        ...
        Image pull policy. One of Always, Never, IfNotPresent. Defaults to Always if :latest tag is specified, or IfNotPresent otherwise. Cannot be updated. More info: http://releases.k8s.io/release-1.1/docs/user-guide/images.md#updating-images
    ...
    def security_context(self):
        ...
        Security options the pod should run with. More info: http://releases.k8s.io/release-1.1/docs/design/security_context.md
