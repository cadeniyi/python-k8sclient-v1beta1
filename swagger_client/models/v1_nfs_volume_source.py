...
class V1NFSVolumeSource(object):
    ...
    def server(self):
        ...
        Server is the hostname or IP address of the NFS server. More info: http://releases.k8s.io/release-1.1/docs/user-guide/volumes.md#nfs
    ...
    def path(self):
        ...
        Path that is exported by the NFS server. More info: http://releases.k8s.io/release-1.1/docs/user-guide/volumes.md#nfs
    ...
    def read_only(self):
        ...
        ReadOnly here will force the NFS export to be mounted with read-only permissions. Defaults to false. More info: http://releases.k8s.io/release-1.1/docs/user-guide/volumes.md#nfs
