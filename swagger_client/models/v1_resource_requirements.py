...
class V1ResourceRequirements(object):
    ...
    def limits(self):
        ...
        Limits describes the maximum amount of compute resources allowed. More info: http://releases.k8s.io/release-1.1/docs/design/resources.md#resource-specifications
    ...
    def requests(self):
        ...
        Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: http://releases.k8s.io/release-1.1/docs/design/resources.md#resource-specifications
