...
class V1SELinuxOptions(object):
    ...
    def user(self):
        ...
        User is a SELinux user label that applies to the container. More info: http://releases.k8s.io/release-1.1/docs/user-guide/labels.md
    ...
    def role(self):
        ...
        Role is a SELinux role label that applies to the container. More info: http://releases.k8s.io/release-1.1/docs/user-guide/labels.md
    ...
    def type(self):
        ...
        Type is a SELinux type label that applies to the container. More info: http://releases.k8s.io/release-1.1/docs/user-guide/labels.md
    ...
    def level(self):
        ...
        Level is SELinux level label that applies to the container. More info: http://releases.k8s.io/release-1.1/docs/user-guide/labels.md
