...
class V1GlusterfsVolumeSource(object):
    ...
    def endpoints(self):
        ...
        EndpointsName is the endpoint name that details Glusterfs topology. More info: http://releases.k8s.io/release-1.1/examples/glusterfs/README.md#create-a-pod
    ...
    def path(self):
        ...
        Path is the Glusterfs volume path. More info: http://releases.k8s.io/release-1.1/examples/glusterfs/README.md#create-a-pod
    ...
    def read_only(self):
        ...
        ReadOnly here will force the Glusterfs volume to be mounted with read-only permissions. Defaults to false. More info: http://releases.k8s.io/release-1.1/examples/glusterfs/README.md#create-a-pod
