...
class UnversionedStatus(object):
    ...
    def metadata(self):
        ...
        Standard list metadata. More info: http://releases.k8s.io/release-1.1/docs/devel/api-conventions.md#types-kinds
    ...
    def status(self):
        ...
        Status of the operation. One of: \"Success\" or \"Failure\". More info: http://releases.k8s.io/release-1.1/docs/devel/api-conventions.md#spec-and-status
