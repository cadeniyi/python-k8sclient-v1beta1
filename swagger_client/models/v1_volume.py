...
class V1Volume(object):
    ...
    def name(self):
        ...
        Volume's name. Must be a DNS_LABEL and unique within the pod. More info: http://releases.k8s.io/release-1.1/docs/user-guide/identifiers.md#names
    ...
    def empty_dir(self):
        ...
        EmptyDir represents a temporary directory that shares a pod's lifetime. More info: http://releases.k8s.io/release-1.1/docs/user-guide/volumes.md#emptydir
    ...
    def gce_persistent_disk(self):
        ...
        GCEPersistentDisk represents a GCE Disk resource that is attached to a kubelet's host machine and then exposed to the pod. More info: http://releases.k8s.io/release-1.1/docs/user-guide/volumes.md#gcepersistentdisk
    ...
    def aws_elastic_block_store(self):
        ...
        AWSElasticBlockStore represents an AWS Disk resource that is attached to a kubelet's host machine and then exposed to the pod. More info: http://releases.k8s.io/release-1.1/docs/user-guide/volumes.md#awselasticblockstore
    ...
    def secret(self):
        ...
        Secret represents a secret that should populate this volume. More info: http://releases.k8s.io/release-1.1/docs/user-guide/volumes.md#secrets
    ...
    def nfs(self):
        ...
        NFS represents an NFS mount on the host that shares a pod's lifetime More info: http://releases.k8s.io/release-1.1/docs/user-guide/volumes.md#nfs
    ...
    def iscsi(self):
        ...
        ISCSI represents an ISCSI Disk resource that is attached to a kubelet's host machine and then exposed to the pod. More info: http://releases.k8s.io/release-1.1/examples/iscsi/README.md
    ...
    def glusterfs(self):
        ...
        Glusterfs represents a Glusterfs mount on the host that shares a pod's lifetime. More info: http://releases.k8s.io/release-1.1/examples/glusterfs/README.md
    ...
    def persistent_volume_claim(self):
        ...
        PersistentVolumeClaimVolumeSource represents a reference to a PersistentVolumeClaim in the same namespace. More info: http://releases.k8s.io/release-1.1/docs/user-guide/persistent-volumes.md#persistentvolumeclaims
    ...
    def rbd(self):
        ...
        RBD represents a Rados Block Device mount on the host that shares a pod's lifetime. More info: http://releases.k8s.io/release-1.1/examples/rbd/README.md
    ...
    def cinder(self):
        ...
        Cinder represents a cinder volume attached and mounted on kubelets host machine More info: http://releases.k8s.io/release-1.1/examples/mysql-cinder-pd/README.md
