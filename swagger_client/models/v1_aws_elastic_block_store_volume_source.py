...
class V1AWSElasticBlockStoreVolumeSource(object):
    ...
    def volume_id(self):
        ...
        Unique ID of the persistent disk resource in AWS (Amazon EBS volume). More info: http://releases.k8s.io/release-1.1/docs/user-guide/volumes.md#awselasticblockstore
    ...
    def fs_type(self):
        ...
        Filesystem type of the volume that you want to mount. Tip: Ensure that the filesystem type is supported by the host operating system. Examples: \"ext4\", \"xfs\", \"ntfs\". More info: http://releases.k8s.io/release-1.1/docs/user-guide/volumes.md#awselasticblockstore
    ...
    def read_only(self):
        ...
        Specify \"true\" to force and set the ReadOnly property in VolumeMounts to \"true\". If omitted, the default is \"false\". More info: http://releases.k8s.io/release-1.1/docs/user-guide/volumes.md#awselasticblockstore
